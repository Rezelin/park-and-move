...
const exercises = {
  ...
  outOfCar: [
    ...
    { name: "Air Squats",             reps: "10 reps",                  duration: 15, emoji: "🦵" },
    { name: "Alternating Lunges",     reps: "10 reps (5 each leg)",     duration: 20, emoji: "🔥" },
    { name: "Arm Circles",            reps: "10 each direction",        duration: 15, emoji: "💪" },
    { name: "High Knees",             reps: "20 reps",                  duration: 20, emoji: "🏃" },
    ...
    { name: "Butt Kicks",             reps: "20 reps",                  duration: 20, emoji: "⚡" },
    { name: "Push-Ups",               reps: "10 reps",                  duration: 20, emoji: "💥" },
    { name: "Standing Side Bends",    reps: "10 each side",             duration: 15, emoji: "↔️" },
    { name: "March In Place",         reps: "30 seconds",               duration: 30, emoji: "🥁" },
    { name: "Forward Fold Hold",      reps: "Hold 15 seconds",          duration: 15, emoji: "🧘" },
    { name: "Chest Opener Stretch",   reps: "Hold 15 seconds",          duration: 15, emoji: "🌟" },
    { name: "Shoulder Stretch",       reps: "10 seconds each side",     duration: 20, emoji: "🤸" },
    { name: "Neck Rolls",             reps: "5 slow rolls each way",    duration: 15, emoji: "😌" },
    { name: "Ankle Circles",          reps: "10 each foot",             duration: 15, emoji: "🦶" },
    { name: "Star Jumps",             reps: "10 reps",                  duration: 20, emoji: "🌠" },
    { name: "Mountain Climbers",      reps: "20 reps",                  duration: 20, emoji: "🏔️" },
    { name: "Wall Sit",               reps: "Hold 20 seconds",          duration: 20, emoji: "🧱" },
    { name: "Glute Bridges",          reps: "10 reps (use bumper!)",    duration: 20, emoji: "🌉" },
    { name: "Hip Flexor Stretch",     reps: "15 seconds each side",     duration: 30, emoji: "🧎" },
    { name: "Trunk Rotations",        reps: "10 each direction",        duration: 15, emoji: "🔄" },
    { name: "Skater Hops",            reps: "10 each side",             duration: 20, emoji: "⛸️" },
    { name: "Standing Figure-4 Stretch", reps: "15 seconds each side",  duration: 30, emoji: "4️⃣" },
  ],
